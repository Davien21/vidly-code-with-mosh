...
describe('/api/genres', () => {
  ...
  describe('POST /', () => {
    ...
    // Define a happy path, 
    // assign the happy path values to repeated variables,
    // in an beforeeach function, and then in each test, 
  ...
  describe('DELETE /:id', () => {
    ...
    it('should remove genre if id is valid and genre exists', async () => {
      await exec();
